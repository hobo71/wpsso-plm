...
(2017/11/24) Added translation to the "Business Days + Hours" option labels. Renamed the WpssoSchema is_schema_type_child_of() method to is_schema_type_child().
